...
<div class="apparatus-3d" data-setup="conductors-charge-distribution"></div>

<div class="apparatus-photo">
<img src="../../assets/apparatus/conductors-charge-distribution.png" alt="Apparatus layout diagram for this experiment">
...
<div class="apparatus-3d-caption"><b>3-D apparatus schematic</b> &middot; drag to rotate, scroll to zoom &middot; A set of virtual conductors (sphere, ellipsoid, conductor-with-a-point) whose surface charge density can be visualised as a heat-map, plus a Van de Graaff generator model with an adjustable belt-charging rate and dome radius.</div>
</div>
