...
<div class="apparatus-3d" data-setup="reflection-refraction-brewster"></div>

<div class="apparatus-photo">
<img src="../../assets/apparatus/reflection-refraction-brewster.png" alt="Apparatus layout diagram for this experiment">
...
<div class="apparatus-3d-caption"><b>3-D apparatus schematic</b> &middot; drag to rotate, scroll to zoom &middot; A virtual ray-optics bench with an EM wave incident on a dielectric interface of adjustable n₁, n₂, with adjustable incidence angle and selectable s- or p-polarization, showing computed reflectance/transmittance and the reflected ray's polarization state.</div>
</div>
