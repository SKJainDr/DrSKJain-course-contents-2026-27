...
<div class="apparatus-3d" data-setup="wave-propagation-media-skindepth"></div>

<div class="apparatus-photo">
<img src="../../assets/apparatus/wave-propagation-media-skindepth.png" alt="Apparatus layout diagram for this experiment">
...
<div class="apparatus-3d-caption"><b>3-D apparatus schematic</b> &middot; drag to rotate, scroll to zoom &middot; A virtual EM wave incident on a slab of adjustable material (dielectric or conductor, with selectable εr, μr, σ), animated to show the wave slowing/attenuating inside, with a live plot of amplitude versus penetration depth.</div>
</div>
