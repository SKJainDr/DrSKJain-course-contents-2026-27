...
<div class="apparatus-3d" data-setup="biot-savart-wire"></div>

<div class="apparatus-photo">
<img src="../../assets/apparatus/biot-savart-wire.png" alt="Apparatus layout diagram for this experiment">
...
<div class="apparatus-3d-caption"><b>3-D apparatus schematic</b> &middot; drag to rotate, scroll to zoom &middot; A virtual straight current-carrying wire of adjustable length and current, with a field probe that can be placed at any perpendicular distance a; the simulator numerically integrates the Biot–Savart law along the wire's length.</div>
</div>
...
Launch the [simulator](../../../labs/advanced-electricity-magnetism-lab.html){target=_blank} and use the following controls on the **Biot–Savart Law — Magnetic Field Due to a Current-Carrying Wire** panel:
...
1. Fix a short wire length L and current I, and vary the probe distance a; plot B vs 1/a and check linearity near the wire's midpoint.
2. Fix a and I, and increase L progressively; observe B approaching the infinite-wire value μ₀I/2πa asymptotically.
3. At fixed a and L, vary I and verify B ∝ I.
4. Move the probe off the wire's perpendicular bisector (nearer one end) and observe the asymmetric α₁, α₂ and resulting change in B.
5. Compare a numerically Biot–Savart-integrated value with the closed-form (sinα₁+sinα₂) formula for several geometries.
6. Use the right-hand rule to verify the predicted direction of B at several probe positions around the wire.
...
*B vs 1/a at fixed I, L &mdash; approx. linear near mid-span*
...
<text x="320.0" y="22" text-anchor="middle" font-size="17" font-weight="700" fill="#0B173A" font-family="Inter,Helvetica,sans-serif">B vs 1/a at fixed I, L</text>
...
<text x="345" y="500" text-anchor="middle" font-size="13" fill="#0B173A" font-family="Inter,Helvetica,sans-serif">1/a (cm⁻¹) &#8594;</text>
...
<div class="apparatus-3d-caption" style="background:var(--lab-navy);"><b>15&times;15 grid</b> &mdash; choose your own scale per square; plot from your observation table. Expected trend: <i>approx. linear near mid-span</i></div>
</div>
...
<div class="error-calc" data-exp="biot-savart-wire"></div>

## Viva-Voce Questions

1. State the Biot–Savart law in vector form and compare its structure with Coulomb's law.
2. Derive the infinite-wire field formula B = μ₀I/2πa as a limiting case of the finite-wire result.
