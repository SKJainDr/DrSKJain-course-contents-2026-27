...
<div class="apparatus-3d" data-setup="rc-rl-transients"></div>

<div class="apparatus-photo">
<img src="../../assets/apparatus/rc-rl-transients.png" alt="Apparatus layout diagram for this experiment">
...
<div class="apparatus-3d-caption"><b>3-D apparatus schematic</b> &middot; drag to rotate, scroll to zoom &middot; A virtual series RC circuit and a series RL circuit, each with a switch to connect/disconnect a battery, adjustable R, C (or L), and a virtual oscilloscope tracing the voltage/current transient in real time with cursors to measure τ.</div>
</div>
