...
<div class="apparatus-3d" data-setup="coulombs-law"></div>

<div class="apparatus-photo">
<img src="../../assets/apparatus/coulombs-law.png" alt="Apparatus layout diagram for this experiment">
...
<div class="apparatus-3d-caption"><b>3-D apparatus schematic</b> &middot; drag to rotate, scroll to zoom &middot; A torsion-balance (Coulomb balance) analogue: a charged pith ball on a torsion fibre is deflected by a second charged ball brought to a variable separation r on an insulating rail; the fibre's restoring torque at equilibrium is proportional to F.</div>
</div>
...
Coulomb's law states that the force between two point charges q1 and q2 separated by a distance r in a medium of permittivity ε acts along the line joining them, is directly proportional to the product of the charges and inversely proportional to the square of the distance between them: F = (1/4πε₀)·q1q2/r² in free space (or F = (1/4πε₀εr)·q1q2/r² in a dielectric medium of relative permittivity εr). The force is repulsive for like charges and attractive for unlike charges. This law is the electrostatic foundation from which Gauss's law, the electric field, and the potential of a point charge are all derived, and it underlies the entire multipole expansion used later for dipoles and extended charge distributions.
...
Launch the [simulator](../../../labs/advanced-electricity-magnetism-lab.html){target=_blank} and use the following controls on the **Coulomb's Law & Force Between Point Charges** panel:

| Control | Symbol | Range | Default |
|---|---|---|---|
| Charge 1 | q₁ | 1–50 nC | 10 nC |
| Charge 2 | q₂ | 1–50 nC | 10 nC |
| Separation | r | 2–30 cm | 10 cm |
| Medium relative permittivity | εr | 1–80  | 1  |

## Procedure

1. Set the medium to vacuum/air (εr = 1) and fix q₁ = q₂ = 10 nC.
2. Vary the separation r from 2 cm to 30 cm in steps of 2 cm, noting the computed force F at each step.
3. Plot log F versus log r and determine the slope; it should equal −2, confirming the inverse-square law.
4. Fix r = 10 cm and vary q₂ from 5 nC to 50 nC, keeping q₁ fixed, and verify F ∝ q₂ (a straight line through the origin on an F vs q₂ plot).
5. Change the medium permittivity εr (e.g. to 80 for water) and observe the reduction in force at fixed q and r.
6. Reverse the sign of one charge and note that the force arrow reverses from repulsive to attractive.
...
*log F vs log r (slope method) &mdash; slope ≈ -2*
...
<text x="320.0" y="22" text-anchor="middle" font-size="17" font-weight="700" fill="#0B173A" font-family="Inter,Helvetica,sans-serif">log F vs log r (slope method)</text>
...
<text x="345" y="500" text-anchor="middle" font-size="13" fill="#0B173A" font-family="Inter,Helvetica,sans-serif">log₁₀ r (r in m) &#8594;</text>
<text x="20" y="252" text-anchor="middle" font-size="13" fill="#0B173A" font-family="Inter,Helvetica,sans-serif" transform="rotate(-90 20 252)">log₁₀ F (F in N) &#8594;</text>
</svg>
</div>
<div class="apparatus-3d-caption" style="background:var(--lab-navy);"><b>15&times;15 grid</b> &mdash; choose your own scale per square; plot from your observation table. Expected trend: <i>slope ≈ -2</i></div>
</div>
...
- Keep the charges' magnitudes fixed while varying only one parameter at a time.
- Ensure the separation r is always much larger than the physical size of the charged spheres so the point-charge approximation holds.
- Note the sign convention: like charges repel (positive F, arrow pointing outward) and unlike charges attract.
- Discharge and re-zero the torsion fibre between widely different charge settings to avoid residual twist error.

## Maximum Permissible Error

$$ ΔF/F = Δq₁/q₁ + Δq₂/q₂ + 2Δr/r $$

F ∝ q₁q₂/r² is a product/quotient of measured quantities, with r entering squared, so its fractional error carries a factor of 2.

<div class="error-calc" data-exp="coulombs-law"></div>
